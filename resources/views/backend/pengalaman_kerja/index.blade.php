                                ...
                                <form id="pengalaman_kerja_form" method="POST"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nama_saham" id="nama_saham" required>
                                        </div>

                                        <div class="form-group mb-3">
                                            <label for="kode_saham">Kode Saham</label>
                                            <input type="text" class="form-control" name="kode_saham" id="kode_saham"
                                                required>
                                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form id="edit_pengalaman_kerja_form" method="POST"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="nama_saham">Nama Saham</label>
                                                    <input type="text" class="form-control" name="nama_saham" id="nama_saham"
                                                        value="{{ $pk->nama_saham }}" required>
                                                </div>

                                                <div class="form-group mb-3">
                                                    <label for="kode_saham">Kode Saham</label>
                                                    <input type="text" class="form-control" name="kode_saham" id="kode_saham"
                                                        value="{{ $pk->kode_saham }}" required>
                                                </div>
...
<script>
    ...
    $("form[name='pengalaman_kerja_form']").validate({
        ...
        messages: {
            nama_Saham: "Mohon isi nama saham",
            Kode_Saham: "Mohon isi kode saham",
            tahun_masuk: {
